...
class Accounts extends Component {
  ...
  handleSubmitAdd = () => {
    axios({
      method: "post",
      url: "http://51.140.34.229:8080/Soloproject/rest/acc/add",
      data: {
  ...
  handleSubmitDelete = () => {
    axios({
      method: "delete",
      url: "http://51.140.34.229:8080/Soloproject/rest/acc/del/" + this.state.id ,
     });
  }
  ...
  handleSubmitUpdate = () => {
    axios({
      method: "put",
      url: "http://51.140.34.229:8080/Soloproject/rest/acc/update/" + this.state.delId ,
      data: {
        name: this.state.name,
        password: this.state.password      
       }
